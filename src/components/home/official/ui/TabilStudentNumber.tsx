...
//     <div className="w-[100vw] md:w-full overflow-x-auto md:overflow-visible">
//       <div className="-mx-4 px-4 md:mx-0 md:px-0">
//         <table className="border-collapse w-[623px] md:w-auto" cellPadding={7}>
//           <thead>
//             <tr>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">ক্রম</th>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">শ্রেণি</th>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">ছেলে</th>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">মেয়ে</th>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">মোট</th>
//               <th className="border border-black px-4 py-2 text-center text-[16px]">মন্তব্য</th>
//             </tr>
//           </thead>
//           <tbody>
//             {tableData.map((row, idx) => {
...
//                       <tr key={gIdx}>
//                         {gIdx === 0 && (
//                           <td rowSpan={row.rowSpan} className="border border-black px-4 py-2 text-center align-top">{row.no}</td>
//                         )}
//                         <td className="border border-black px-4 py-2 text-[16px]">{g.className}</td>
//                         <td className="border border-black px-4 py-2">{g.boy}</td>
//                         <td className="border border-black px-4 py-2">{g.girl}</td>
//                         <td className="border border-black px-4 py-2">{g.total}</td>
//                         <td className="border border-black px-4 py-2">{g.comment || "\u00A0"}</td>
//                       </tr>
//                     ))}
//                   </React.Fragment>
//                 );
...
//               return (
//                 <tr key={idx}>
//                   <td className="border border-black px-4 py-2 text-center">{row.no}</td>
//                   <td className="border border-black px-4 py-2 text-[16px]">{row.className}</td>
//                   <td className="border border-black px-4 py-2">{row.boy}</td>
//                   <td className="border border-black px-4 py-2">{row.girl}</td>
//                   <td className="border border-black px-4 py-2">{row.total}</td>
//                   <td className="border border-black px-4 py-2">{row.comment || "\u00A0"}</td>
//                 </tr>
//               );
//             })}
//           </tbody>
